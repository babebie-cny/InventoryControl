...
$axSql_rack= $oDB->Query("SELECT * FROM tbl_location"); 
...
// $asData['firstname'] = $oDB->QueryOne("SELECT CONCAT(no2.firstname, ' ',no2.lastname) as Nameinsert FROM ted_nmr no INNER JOIN tbl_user_login no2 WHERE no.user_insert=no2.id AND no.id = ".$asData['id']);
    ...
    <section class="content">
      ...
      <form name="dataform" id="dataform" action="" method="post" enctype="multipart/form-data" >
        <div class="row">
          ...
          <div class="row">	
            ...
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="input" name="du_asset_code" id="du_asset_code" value="<?php echo isset($axSql['asset_code']) ? $axSql['asset_code'] : '';?>" class="form-control" placeholder="Asset Code..." readonly>
              </div>
					</div>
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="form-group">
                  ...
                  <input type="input" name="du_parent_asset" id="du_parent_asset"   value="<?php echo isset($axSql['parent_asset']) ? $axSql['parent_asset'] : '';?>" class="form-control" placeholder="Parent_Asset..." >
              </div>
					  </div>
				  </div>
         ...
         <?php if ($axSql['insert_date']!='0000-00-00 00:00:00') { ?> 
          <div class="row">	
            <div class="col-md-6">
            <div class="info-box">
              <span class="info-box-icon bg-info"><i class="far fa-clock"></i></span>
              <div class="info-box-content">
                <span class="info-box-text">Create Date</span>
                <span class="info-box-number"><?php echo $axSql['insert_date'];?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-6">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Update Date</span>
                <?php if ($axSql['update_date']!='0000-00-00 00:00:00') { ?> 
                <span class="info-box-number"><?php echo $axSql['update_date'];?></span>
                <?php }else{ ?> 
          ...
          <!-- <div class="row">	
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="input" name="du_acq_value_balance" id="du_acq_value_balance"   value="<?php echo isset($axSql['acq_value_balance']) ? $axSql['acq_value_balance'] : '';?>" class="form-control" placeholder="Acq Value Balance..." >
              </div>
					</div>
            <div class="col-md-6">
              <div class="form-group">
                  <label>Netbk.Val FYE</label>
                  <input type="input" name="du_netbk_val_fye" id="du_netbk_val_fye"   value="<?php echo isset($axSql['netbk_val_fye']) ? $axSql['netbk_val_fye'] : '';?>" class="form-control" placeholder="Netbk.Val FYE..." >
              </div>
					  </div>
				  </div> -->
          ...
          <button type="submit" class="btn btn-success" onClick="this.form.action='register_form_confirm.php?id=<?php echo $sID;?>'">Confirm Equipment Data</button>	
					...
					<input name="act_update" type="hidden" id="act_update" value="update" />
					</div>
          </div>
...
<script type="text/javascript">
      $('#du_building_id').change(function() {
        ...
        $.ajax({
          type: "post",
          url: "location_api_draft.php",
          data:{id:id_building,function:'du_building_id'},
      ...
      $('#du_floor_id').change(function() {
        ...
        $.ajax({
          type: "post",
          url: "location_api_draft.php",
          data:{id:id_floor,function:'du_floor_id'},
          success: function(data){
      ...
      $('#du_room_id').change(function() {
        ...
        $.ajax({
          type: "post",
          url: "location_api_draft.php",
          data:{id:id_room,function:'du_room_id'},
          success: function(data){
