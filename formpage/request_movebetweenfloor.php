...
@media (max-width: 575px) {
  ...
  .u-section-2 .u-text-2 {
    ...
    <link rel="stylesheet" href="./css_/cbbox.css" media="screen">
    <script type="text/javascript" src="./css_/cbboxscript.js" defer=""></script>
    <link rel="stylesheet" href="./css_/searchdialog.css" media="screen">
    <script type="text/javascript" src="./css_/searchdialog_script.js" defer=""></script>
                ...
                <div class="u-layout-row">
                  <div class="u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-2">
                    <div class="u-container-layout u-container-layout-2">
                      <h5 class="u-text u-text-grey-70 u-text-1" style="font-size: 2rem;">Move Between Floor Equipment Form</h5>
                        ...
                        <form action="https://nicepage.com/editor/Forms/Process" method="POST" class="u-block-25d6-21 u-clearfix u-form-spacing-25 u-form-vertical u-inner-form" source="email"><!-- hidden inputs for siteId and pageId -->
                          <div class="u-form-group u-form-name">
                            <div style="text-align: center;" >
                              <a href="#">
                                <img src="./img/QRscan.png" alt="Paris" width="50" height="50">
                              </a>
                          ...
                          <div class="u-form-group u-form-name">
                            ...
                            <div style="width: 10%; right: 0; float: left; padding: 5px; ">
                               <a href="#">
                                <img src="./img/searchicon.png" id="searchbt" alt="Paris" width="35" height="35">
                              </a>
                            </div>
                          </div><!-- always visible -->
                          <div class="u-form-group u-form-name">
                            <label for="name-e4cc" class="u-form-control-hidden u-label">Asset_code</label>
                            <input type="text" placeholder="Asset code" id="name-e4cc" name="Asset_code" class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle" required="">
                          </div><!-- always visible -->
                          <div class="u-form-group u-form-name">
                            <label for="name-e4cc" class="u-form-control-hidden u-label">series_code</label>
                            <input type="text" placeholder="series code" id="name-e4cc" name="series_code" class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle" required="">
                          </div><!-- always visible -->
                        
                       
                          <div class="u-form-group u-form-name">
                            <label for="name-e4cc" class="u-form-control-hidden u-label">address_item</label>
                            <input  type="text" placeholder="ตำแหน่งอุปกรณ์ปัจจุบัน" id="name-e4cc" name="address_item" class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle" readonly required="" >
                          </div><!-- always visible -->
                          <div class="u-form-group u-form-name">
                            <label for="name-e4cc" class="u-form-control-hidden u-label">Move_address</label>
                            <input type="text" placeholder="ตำแหน่งอุปกรณ์ที่ต้องการย้าย" id="name-e4cc" name="Move_address" class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-grey-5 u-input u-input-rectangle" required="">
                          </div><!-- always visible -->
                          <div class="u-form-email u-form-group">
                            <label for="email-e4cc" class="u-form-control-hidden u-label">job_assing</label>
                            <div class="custom-select" style="width:100%;">
                              <select name="job_assing">
                                <option value="0">ผู้รับผิดชอบอุปกรณ์</option>
                                <option value="1">สมชาย</option>
                                <option value="2">อนุสรณ์</option>
                                <option value="3">ชูเกรียติ</option>
                                <option value="4">ดำรงศักดิ์</option>
                                <option value="5">จตุพร</option>>
                              </select>
                            </div>
