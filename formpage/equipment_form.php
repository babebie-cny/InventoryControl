...
$axSql = $oDB->QueryRow("SELECT * FROM tbl_equipment WHERE id='" . $sID . "' ", DBI_ASSOC);
$axSql['createuser'] = $oDB->QueryOne("SELECT CONCAT(n2.firstname,' ',n2.lastname) FROM tbl_equipment n1 INNER JOIN tbl_user_login n2 WHERE n1.user_insert = n2.id AND n1.id='" . $sID . "' ");
$axSql['updateuser'] = $oDB->QueryOne("SELECT CONCAT(n2.firstname,' ',n2.lastname) FROM tbl_equipment n1 INNER JOIN tbl_user_login n2 WHERE n1.user_update = n2.id AND n1.id='" . $sID . "' ");
...
<body class="hold-transition sidebar-mini sidebar-collapse">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Equipment Details<?php echo $head_title; ?></h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Equipment Details<?php echo $head_title; ?></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
    ...
    if ($sACT == 'edit') {
        ...
        $UpdateSql = "UPDATE tbl_equipment SET " . $sSetDataUpdate . " WHERE id=" . $sID;

        if ($oDB->Execute($UpdateSql)) {
          echo '
  <script type="text/javascript">
  alertSuccess("Save Equipment Data","equipment_list.php")
  </script>
  ';
        } else {
          $asPost = array();
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-12">
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" onClick="this.form.action='equipment_form.php?act_update=update&id=<?php echo $sID; ?>'">Save Data</button>
