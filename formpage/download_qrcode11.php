...
$equip_code = $_GET["equip_code"];
$sID = $_GET["id"];
$sCompanyCode = $oDB->QueryOne("SELECT companycode FROM tbl_equipment_sap WHERE id='" . $sID . "' ");
$sCompanyName = $oDB->QueryOne("SELECT company_name FROM tbl_company WHERE company_code='" . $sCompanyCode . "' ");
?>
...
<body class="hold-transition sidebar-mini sidebar-collapse">
  ...
  <script>
    ...
    var code = "<?php echo $equip_code; ?>".slice(0, 15);
    var code2 = "<?php echo $equip_code; ?>".slice(14, 26);
    // alert(code2);
    <?php
    if (!empty($equip_code)) {
    ...
    function generate(data, data2) {
      ...
      let headQR_div = document.createElement("div");
      headQR_div.setAttribute("style", "margin-left: -2.0rem; margin-top: -1.00rem; font-weight: bolder; font-size: 45px; font-family:Verdana, Geneva, Tahoma, sans-serif");
      headQR_div.innerText = "<?php echo $sCompanyName ?>";
      div_element.appendChild(headQR_div);
      ...
      equipment_code.innerText = data;
      equipment_code.style = "grid-column-start: 1;grid-column-end: 3;text-align: left; font-weight: bold; font-size: 28px; font-family:Verdana, Geneva, Tahoma, sans-serif";
