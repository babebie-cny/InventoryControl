...
$cs = $axSql_groupequipment['class_sub'] ;
$sYear = date("y");
$sMonth = date("m");
$emc = $cs.$sYear.$sMonth."000001";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Register Equipment Approvement</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Register Equipment Approvement</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <form name="dataform" id="dataform" action="" method="post" enctype="multipart/form-data" >
        <div class="row">
          ...
          <button type="submit" value="approve" id="approve" class="btn btn-primary btn-block mr-1 my-1"><i class="bi bi-check-square"></i> Approve</button>	
          </div>
          <div class="col-md-4 col-lg-2 col-sm-12">
          <button value="reject" id="reject" class="btn btn-danger btn-block mr-1 my-1"> <i class="bi bi-x-square"></i> Reject</button>
          </div>
          <div class="col-md-4 col-lg-2 col-sm-12">
          <a value="edit" id="edit" value="<?php echo $_REQUEST['du_sap_id'];?>" 
          onclick="location.href='register_formEdit.php?id=<?php echo $_REQUEST['du_sap_id'];?>'" class="btn btn-warning btn-block mr-1 my-1"><i class="bi bi-pencil-square"></i> Edit</a>
          </div>
