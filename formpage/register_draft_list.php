...
$axSql= $oDB->Query("SELECT * FROM tbl_register_draft WHERE user_insert ='".$sUserID."' AND approve_status='N' 
        ORDER BY CASE
        WHEN approve_status = 'N' then 1
        WHEN approve_status = 'A' then 2
        END ASC    
         ");
					$rownum= 1;			
        ...
        $asResult["equipmentstatus"] = $oDB->QueryOne("SELECT sap_id FROM tbl_equipment WHERE sap_id='".$asResult["sap_id"]."' ");
?>
        ...
        <tr>
          ...
          <?php if ($asResult["sap_id"]==0){ ?>      
              ...
              <a style="margin-left: 5px;" class="btn btn-info btn-xs" href="register_nonsap_form.php?act=edit&id=<?php echo $asResult["id"];?>">
          ...
          <?php }else{ ?>
              <?php if ($asResult["approve_status"]=='N'){ ?>         
              <a style="margin-left: 5px;" class="btn btn-info btn-xs" href="register_form.php?act=edit&id=<?php echo $asResult["id"];?>">
              <i style="margin-right: 5px;" class="fas fa-edit"></i>
                    Edit Draft
              </a>
              <?php } ?>
