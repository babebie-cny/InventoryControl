...
$axSql= $oDB->Query("SELECT * FROM tbl_equipment_sap");
					$rownum= 1;			
...
?>
        ...
        <tr>
          ...
          <td><?php echo $asResult["company_code"];?></td>
          <!-- <td><?php //echo $asResult["employee_id"];?></td> -->
          <td><?php echo $asResult["class"];?></td>                    
          <td><?php echo $asResult["class_name"];?></td>                    
          <td><a href="register_sap_detail.php?act=view&id=<?php echo $asResult["id"];?>"><?php echo $asResult["asset"];?></a></td>       
					<td><?php echo $asResult["sub"];?></td>
					<td><?php echo $asResult["description1"];?></td>
					<td><?php echo $asResult["cost_center"];?></td>
					<td><?php echo $asResult["qty"];?></td>
					<td><?php echo $asResult["cap_date"];?></td>
					<td><?php echo $asResult["vendor_name"];?></td>
					 <?php $rownum = $rownum+1; ?>
