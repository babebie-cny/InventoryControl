              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="card-footer">
                    <?php
                    $sSAP_EXT = $oDB->QueryRow("SELECT id FROM tbl_equipment WHERE sap_id='" . $sID . "'", DBI_ASSOC);
                    if (!$sSAP_EXT) {
                    ?>
                      <form name="dataform" id="dataform" action="register_form.php" method="post" enctype="multipart/form-data">
                        <button type="submit" class="btn btn-primary" value="save">Copy Data To Register Equipment Form</button>
